...
INSERT INTO new_prop (id, date_created, description, title, price, admin_fan_id, registered_user_id,show_id) VALUES (1, '2018-01-29 00:55:56', 'Veoma glasna sirena', 'Sirena', 500, 1, 4,1);
INSERT INTO new_prop (id, date_created, description, title, price, admin_fan_id, registered_user_id,show_id) VALUES (2, '2018-01-24 03:55:56', 'Sesir za film', 'Sesir', 150, 1, 4,1);
...
INSERT INTO used_prop (id, date_created, description, title, active_until,accepted_bid, status, registered_user_id) VALUES (2, '2018-01-27 02:32:40', 'Polovna maska za maskembal damska.', 'Maska damska', '2018-02-15 02:32:45',0, 'WAITING', 4);
