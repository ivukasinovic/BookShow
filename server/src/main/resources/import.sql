...
INSERT INTO user (istorija_poseta,role, city, email, name, number, password_hash, surname, username, points,type, changed_password,activated) VALUES ('','USER','Novi Sad', 'milan@milan', 'Milan', '0645565239', '$2a$10$fbc8Mb9ec0Ig1M5D0R8zT.xMgF0E1r6li04ynzi/CKY3eev/vezH2', 'Stankovic', 'milan',45,'DEFAULT', false, true);
INSERT INTO user (istorija_poseta,role, city, email, name, number, password_hash, surname, username, points,type, changed_password,activated) VALUES ('','ADMINSYS','Novi Grad', 'grad@milan', 'Grad', '0644565239', '$2a$08$lDnHPz7eUkSi6ao14Twuau08mzhWrL4kyZGGU5xfiGALO/Vxd5DOi', 'Stankovic', 'admin',567,'DEFAULT', false, true);
